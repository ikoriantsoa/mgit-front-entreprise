        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Découvrez les profils de nos talents et regardez leurs montées en compétences.
            </p>
          </div>
                  ...
                  {selectedTrainee.certifications &&
                    selectedTrainee.certifications.length > 0 && (
                      <div className="space-y-3">
                        ...
                        <Button className="">Demander à MGIT Service de programmer un entretien</Button>
                      </div>
                    )}
                </div>
              </>
